" =============================================================================
" Filename: autoload/lightline/colorscheme/solarizedmine.vim
" Author: itchyny
" License: MIT License
...
let s:p.tabline.tabsel = [ [ s:base03, s:green ] ]
let s:p.tabline.middle = [ [ s:base0, s:base02 ] ]
let s:p.tabline.right = copy(s:p.tabline.left)
let s:p.normal.error = [ [ s:base03, s:red ] ]
let s:p.normal.warning = [ [ s:base03, s:yellow ] ]

let g:lightline#colorscheme#solarizedmine#palette = lightline#colorscheme#flatten(s:p)
